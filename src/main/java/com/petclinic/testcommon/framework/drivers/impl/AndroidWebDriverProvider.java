...
import static com.petclinic.testcommon.model.common.Browser.CHROME_ANDROID;
...
public class AndroidWebDriverProvider extends BaseMobileWebDriverProvider implements RemoteWebDriverProvider {
    ...
    private static String getRandomAndroidDevice() {
        ...
        String selectedAndroidDevice = androidDevicesList.toArray()[new Random().nextInt(androidDevicesList.size())].toString();
