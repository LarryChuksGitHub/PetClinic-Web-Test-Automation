...
import static com.petclinic.testcommon.config.Config.BROWSER;
import static com.petclinic.testcommon.config.Config.PLATFORM_NAME;
import static com.petclinic.testcommon.config.hooks.Hooks.isMobilePlatform;
import static com.petclinic.testcommon.framework.drivers.impl.IosWebDriverProvider.APP_NAME;
import static com.petclinic.testcommon.model.common.Browser.SAFARI_IOS;
...
import com.petclinic.testcommon.framework.utils.logging.LoggingFilters;
...
public class BrowserstackProvider extends CloudProvider {
    ...
    public DesiredCapabilities getIosCapabilities(final String iosDeviceName,
        ...
        if (PLATFORM_NAME == IPAD) {
            String[] localIdentApp = {getAppUrl(appFileExtension)};
    ...
    public String getAppId(final String app) throws JSONException {
        String json = getBrowserStackAppDataForCustomId("");
